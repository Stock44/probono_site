...
export default function Dropdown(props: DropdownProps) {
	return 'isOpen' in props ? <BaseDropdown {...props}/> : <StatefulDropDown {...props}/>;
}

export type StatefulDropDownProps = Omit<BaseDropdownProps, 'isOpen' | 'onToggle'> & {
			...
			<AnimatePresence>
				{
					isOpen && (
						<motion.div
							layout
							className='text-stone-300 p-2' initial={{
								height: 0,
							}} animate={{
								height: 'auto',
							}}
