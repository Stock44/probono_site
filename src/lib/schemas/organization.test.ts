...
import { countNullAttributes } from '../models/organization';
...
/*
	...
	test( "empty org must have 0% completion" , () =>{expect(countNullAttributes(9)).toBe(37)} );
	/* 
  ...
  cluniStatus: null,
  addressId: null,
  employeeCountCategoryId: null,
  volunteerCountCategoryId: null,
  ...
  ageGroups: null,
  beneficiaries: null,
  collaboratingGovernmentOrganizations: [],
  collaboratingMunicipalities: [],
  providedServices: [],
  sectors: [ ],
  activities: [
  ],
