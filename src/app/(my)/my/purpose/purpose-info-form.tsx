...
import AgeGenderGroupSelector, {type GenderedAgeGroup} from '@/app/(my)/my/purpose/age-gender-group-selector.tsx';
import ActivityPrioritySelector from '@/app/(my)/my/purpose/activity-priority-selector.tsx';
