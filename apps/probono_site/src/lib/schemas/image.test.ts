...
it('should validate properly sized and typed image', async () => {
	...
	const whitePixelPngStartBytes = new Uint8Array([
		137, 80, 78, 71, 13, 10, 26, 10, 0, 0, 0, 13, 73, 72, 68, 82, 0, 0, 0,
		1, 0, 0, 0, 1, 8, 6, 0, 0, 0, 1, 115, 122, 122, 244, 0, 0, 0, 9, 112,
		72, 89, 115, 0, 0, 11, 19, 0, 0, 11, 19, 1, 0, 154, 156, 24, 0, 0, 0, 7,
		116, 73, 77, 69, 7, 228, 2,
	]).buffer;
